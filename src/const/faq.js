module.exports = [
  {
    ...
    desc: "You don't need any prefix since we now use Slash Commands.<br>" +
      '<br>' +
  ...
  },
  {
    ...
    desc: '<code>/config-xp xp-per</code><br>' +
  ...
  },
  {
    ...
    desc: 'The level factor says how many XP more per level you need. See below the definition of each number as well as how it is calculated.<br>' +
      '<br>' +
  ...
  },
  {
    ...
    desc: '-> To add a role use <code>/config-role levels</code> and fill out the required fields.<br>' +
  ...
  },
  {
    ...
    desc: 'You can deactivate textmessage XP, voice XP, invite XP or like/vote XP<br>' +
  ...
  },
  {
    ...
    desc: '1. Either use <code>/config-server set</code> and choose between "Notify via DM" or "Notify Last Active Channel"<br>' +
  ...
  },
  {
    ...
    desc: 'Votes (or Likes) are a way for users to give someone XP. You can use the command <code>/member upvote</code> or you can activate reaction voting on your server with <code>/config-server set</code> and choose "reaction vote",<br>' +
      '<br>' +
  ...
  },
  {
    ...
    desc: 'The monthly stats reset every 2nd day of the month <t:1654560000:T>.<br>' +
  ...
  },
  {
    ...
    desc: 'If there are no commands listed if you type <code>/</code>, <a href="https://discord.com/api/oauth2/authorize?client_id=534589798267224065&permissions=294172224721&scope=bot%20applications.commands">reinvite the bot</a> and wait 5 minutes.<br>' +
      '<br>' +
  ...
  },
  {
    ...
    desc: 'Most likely you just need to disconnect and connect back to any voice channel, wait a few minutes and then check your stats again.<br>' +
      '<br>' +
  ...
  },
  {
    ...
    desc: 'You can set one person as Inviter -> The person who invited you. <code>/inviter member:</code><br>' +
