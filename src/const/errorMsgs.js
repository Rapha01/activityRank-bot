exports.noSubcommand =
  "Please specify the subcommand. Type ``<prefix>help`` for more information.";
exports.invalidSubcommand =
  "Invalid subcommand. Type ``<prefix>help`` for more information.";
exports.tooFewArguments =
  "Too few arguments. Type ``<prefix>help`` for more information.";
exports.invalidArgument =
  "Invalid argument. Type ``<prefix>help`` for more information.";
