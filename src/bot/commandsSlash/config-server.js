...
module.exports.data = new SlashCommandBuilder()
  ...
  .addSubcommand((sc) =>
    sc
      ...
      .addStringOption((o) =>
        o.setName('tag').setDescription('The bonusTag to set')
      )
      .addStringOption((o) =>
        o.setName('emote').setDescription('The bonusEmote to set')
      )
  )
  .addSubcommand((sc) =>
    sc
      ...
      .addStringOption((o) =>
        o.setName('tag').setDescription('The voteTag to set')
      )
      .addStringOption((o) =>
        o.setName('emote').setDescription('The voteEmote to set')
      )
  )
  .addSubcommand((sc) =>
    sc
      ...
      .setDescription(
        'Set the number of entries per page in embeds sent by the bot'
      )
      .addIntegerOption((o) =>
        o
          .setName('value')
