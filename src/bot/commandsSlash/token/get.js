  ...
  await i.reply({
    embeds: [
      new EmbedBuilder()
        ...
        .setColor('#4fd6c8')
        .addFields({ name: '**[*3* tokens]** Top.gg (possible every 12h)', value: 'https://top.gg/bot/534589798267224065' }),
      new EmbedBuilder()
        .setTitle('Buy tokens to fuel the bot and redeem for other boosts.')
        .setColor('#4fd6c8')
        .addFields({ name: '**[ 1€ / *1000* tokens ]**', value: 'Visit https://activityrank.me/premium to purchase.' }),
    ],
    ephemeral: true,
