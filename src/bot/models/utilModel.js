...
exports.storage.getLastActivities = (guild,userId,timestamp = false) => {
  return new Promise(async function (resolve, reject) {
    try {
      ...
      else lastActivities.textMessage = (res.length > 0) ? (new Date(res[0].changeDate * 1000)).toString().slice(0,16) : 'n/a';
      ...
      else lastActivities.voiceMinute = (res.length > 0) ? (new Date(res[0].changeDate * 1000)).toString().slice(0,16) : 'n/a';
      ...
      else lastActivities.invite = (res.length > 0) ? (new Date(res[0].changeDate * 1000)).toString().slice(0,16) : 'n/a';
      ...
      else lastActivities.vote = (res.length > 0) ? (new Date(res[0].changeDate * 1000)).toString().slice(0,16) : 'n/a';
      ...
      else lastActivities.bonus = (res.length > 0) ? (new Date(res[0].changeDate * 1000)).toString().slice(0,16) : 'n/a';
