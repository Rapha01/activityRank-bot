...
function info(msg,myGuild) {
  return new Promise(async function (resolve, reject) {
    try {
      ...
      embed.addField('Roles','Please check ``' + myGuild.prefix + 's info roles``.',true);
      embed.addField('Levels','Please check ``' + myGuild.prefix + 's info levels``.',true);
      embed.addField('NoXP channels','Please check ``' + myGuild.prefix + 's info noXpchannels``.');
      embed.addField('NoXP roles','Please check ``' + myGuild.prefix + 's info noXpRoles``.',true);
