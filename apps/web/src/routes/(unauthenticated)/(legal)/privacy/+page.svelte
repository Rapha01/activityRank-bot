...
<div>
	<h2>Overview</h2>
	<p>
		At ActivityRank, accessible from activityrank.me, one of our main priorities is the privacy of
		our visitors. This Privacy Policy document contains types of information that is collected and
		recorded by ActivityRank and how we use it. If you have additional questions or require more
		information about our Privacy Policy, do not hesitate to contact us. This Privacy Policy applies
		only to our online activities and is valid for visitors to our website with regards to the
		information that they shared and/or collect in ActivityRank. This policy is not applicable to
		any information collected offline or via channels other than this website and bot. Our Privacy
		Policy was created with the help of the Privacy Policy Generator and the Generate Privacy Policy
		Generator.
	</p>
	...
	<p>
		...
		your name, email address, phone number, the contents of the message and/or attachments you may
		send us, and any other information you may choose to provide. When you register for an Account,
		we may ask for your contact information, including items such as name, company name, address,
	...
	<ul>
		<li>
			Provide, operate, and maintain our webste Improve, personalize, and expand our website and
			bot.
		</li>
	...
	<h2>Log files</h2>
	<p>
		ActivityRank follows a standard procedure of using log files. These files log visitors when they
		visit website and bot. All hosting companies do this and a part of hosting services&apos;
		...
		tracking users&apos; movement on website and bot, and gathering demographic information.
	</p>

	<h2>Cookies and Web Beacons</h2>
	<p>
		Like any other website, ActivityRank uses cookies. These cookies are used to store information
	...
	<p>
		...
		pieces of personal data that a business has collected about consumers. Request that a business
		delete any personal data about the consumer that a business has collected. Request that a
		business that sells a consumer&apos;s personal data, not sell the consumer&apos;s personal data.
	...
	<ul>
		...
		<li>
			The right to rectification &mdash; You have the right to request that we correct any
		...
		<li>
			The right to object to processing &mdash; You have the right to object to our processing of
	...
	<p>
		...
		online activity. ActivityRank does not knowingly collect any Personal Identifiable Information
		from children under the age of 13. If you think that your child provided this kind of
		information on our website and bot, we strongly encourage you to contact us immediately and we
